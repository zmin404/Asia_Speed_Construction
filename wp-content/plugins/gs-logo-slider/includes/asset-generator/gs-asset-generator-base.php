...
if ( ! class_exists('GS_Asset_Generator_Base') ) {
    ...
    abstract class GS_Asset_Generator_Base {
        ...
        public function __construct() {
            ...
            add_filter( 'gsp_shortcode_updated', [ $this, 'assets_purge_all' ] );
            add_filter( 'gsp_preference_update', [ $this, 'assets_purge_all' ] );
        }
        ...
        final public function enqueue( $main_post_id, $is_preview = false ) {
            ...
            if ( !empty($assets) ) {
                do_action( 'GS_Plugins/Load_Assets/' . $this->get_assets_key(), $main_post_id, $assets, $is_preview );
            }
