...
(function($) {
  ...
  function SPLCAjaxChosen(element, options) {
    this.element = $(element);
    this.options = options;
    this.init();
  };

  SPLCAjaxChosen.prototype.init = function() {
  ...
  SPLCAjaxChosen.prototype.events = function() {
  ...
  SPLCAjaxChosen.prototype.search_field_focused = function() {
  ...
  SPLCAjaxChosen.prototype.search_welcome_message = function() {
  ...
  SPLCAjaxChosen.prototype.update_list = function() {
    ...
    this.timer = setTimeout( function() {
      ...
      _this.chosenXhr = window.wp.ajax.post('splogocarousel-chosen', _this.options.data).done( function( response ) {
  ...
  SPLCAjaxChosen.prototype.show_results = function( items ) {
    ...
    if( this.is_multiple ) {
      ...
      var $hidden_select = this.element.parent().find('.splogocarousel-hide-select');
      var $hidden_value  = $hidden_select.val() || [];

      this.element.SPLCChosenOrder($hidden_value, true);
  ...
  $.fn.SPLCAjaxChosen = function(chosenOptions) {
    return this.each(function() {
      new SPLCAjaxChosen(this, chosenOptions);
    });
  };
...
(function() {
  var $, SPLCAbstractChosenOrder, _ref,
    __indexOf = [].indexOf || function(item) { for (var i = 0, l = this.length; i < l; i++) { if (i in this && this[i] === item) return i; } return -1; },
    __hasProp = {}.hasOwnProperty,
    __extends = function(child, parent) { for (var key in parent) { if (__hasProp.call(parent, key)) child[key] = parent[key]; } function ctor() { this.constructor = child; } ctor.prototype = parent.prototype; child.prototype = new ctor(); child.__super__ = parent.prototype; return child; };

  SPLCAbstractChosenOrder = (function() {

    function SPLCAbstractChosenOrder() {}

    SPLCAbstractChosenOrder.insertAt = function(node, index, parentNode) {
      return parentNode.insertBefore(node, parentNode.children[index].nextSibling);
    };

    SPLCAbstractChosenOrder.getFlattenedOptionsAndGroups = function(select) {
    ...
    SPLCAbstractChosenOrder.isValidMultipleSelectElement = function(element) {
      return element !== null && typeof element !== "undefined" && element.nodeName === "SELECT" && element.multiple;
    };

    SPLCAbstractChosenOrder.getChosenUIContainer = function(select) {
      if (select.id !== "") {
    ...
    SPLCAbstractChosenOrder.isChosenified = function(select) {
      return this.getChosenUIContainer(select) != null;
    };

    SPLCAbstractChosenOrder.forceSelection = function(select, selection) {
    ...
    SPLCAbstractChosenOrder.SPLCChosenOrder = function(select, order, force) {
    ...
    return SPLCAbstractChosenOrder;
  ...
  $.fn.extend({
    SPLCChosenOrder: function(order, force) {
      return _SPLCChosenOrder.SPLCChosenOrder(this, order, force);
    }
  });

  this._SPLCChosenOrder = (function(_super) {
    __extends(_SPLCChosenOrder, _super);

    function _SPLCChosenOrder() {
      _ref = _SPLCChosenOrder.__super__.constructor.apply(this, arguments);
      return _ref;
    }

    _SPLCChosenOrder.relAttributeName = 'data-option-array-index';

    _SPLCChosenOrder.isjQueryObject = function(obj) {
      return (typeof jQuery !== "undefined" && jQuery !== null) && obj instanceof jQuery;
    };

    _SPLCChosenOrder.getDOMElement = function(element) {
    ...
    _SPLCChosenOrder.searchChosenUIContainer = function(element) {
    ...
    _SPLCChosenOrder.triggerEvent = function(target, event_name) {
      return $(target).trigger(event_name);
    };

    return _SPLCChosenOrder;

  })(SPLCAbstractChosenOrder);
    ...
    applyRule: function(context, enforced) {
      ...
      if( result ) {
        ...
        $(controls).each(function() {
          $(this).removeClass('splogocarousel-depend-on');
        });
        ...
        $(controls).each(function() {
          $(this).addClass('splogocarousel-depend-on');
        });
...
(function(root, factory) {
  ...
  if (typeof $.fn !== "undefined") {
    $.fn.serializeObjectSPLC = FormSerializer.serializeObject;
    $.fn.serializeJSONSPLC   = FormSerializer.serializeJSON;
  }
